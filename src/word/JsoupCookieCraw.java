...
//        login();
        ...
        cookies.put("JSESSIONID", "3F038C8AA9A655477F59D68322FA59CA");
...
//        	System.err.println(document4.toString());
    		...
    		MDoc mdoc = new MDoc();
//    		mdoc.createDoc(dataMap, "/javaWordTest/"+gh+es.get(5).attr("value")+".doc");
    		mdoc.createDoc(dataMap, "/Users/yehaitao/Desktop/javaWordTest/"+gh+es.get(5).attr("value")+"d.doc");
